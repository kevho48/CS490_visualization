...
void bacteria::bacterialOptimization(int n)
{
...
void bacteria::chemotaxisAndSwim(
    std::vector<cell_t> &population,
    int n,
...
double bacteria::cellInteraction(std::vector<cell_t> population, cell_t cell, double ATTRACT_D, double ATTRACT_W, double REPEL_H, double REPEL_W)
{
...
std::vector<double> bacteria::getRandDir(int n)
{
...
std::vector<double> bacteria::genRandSol(int n)
{
...
double bacteria::evalFitness(std::vector<double> v)
{
...
void bacteria::printVector(std::vector<double> v)
{
    for (double x : v)
    {
        printf("%f, ", x);
